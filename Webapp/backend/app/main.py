...
from app.api.endpoints import listings, auth, accounts
# Temporarily commented out to fix core imports first
# from app.api.endpoints import optimize, orders, sources, dashboard, export, sync, drafts, messages, account_sheets, products, roles, sheets_sync, extension, multi_sheet_sync, csv_import, csv_upload
...
# 
# app.include_router(
#     multi_sheet_sync.router,
#     prefix=f"{settings.API_V1_STR}/multi-sheet",
#     tags=["multi-sheet-sync"]
# )
# 
# app.include_router(
#     csv_import.router,
...
async def api_health_check():
    """Health check endpoint for API version"""
    return {
        "status": "healthy",
        "service": settings.PROJECT_NAME,
        "version": settings.VERSION,
